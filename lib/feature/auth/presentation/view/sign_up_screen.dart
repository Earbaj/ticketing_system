          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  SizedBox(height: 25,),
                  Text("Sign Up",style: TextStyle(fontSize: 45,fontWeight: FontWeight.bold),),
                  SizedBox(height: 10,),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                  ...
                  SizedBox(height: 10,),
                  Image.asset("assets/images/sign_up_screen_logo.png",fit: BoxFit.scaleDown,width: 420,height: 300,),
                  SizedBox(height: 10,),
                  TextFormField(
